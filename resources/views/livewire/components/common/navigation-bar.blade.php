    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-800">
        <div class="flex items-center">
            ...
            <div class="ml-3 flex-1 min-w-0">
                <p class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">{{ $userData->name }}
                </p>
                <p class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ $userData->email }}</p>
            </div>
            <form method="POST" action="{{ route('system.logout') }}" class="inline">
                @csrf
                <button type="submit"
